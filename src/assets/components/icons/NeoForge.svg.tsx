interface NeoForgeIconProperties
{
    width?: number | string;
...
export function NeoForge(props: NeoForgeIconProperties)
{
    const {width, height, size, fill} = props;
    return (
        <svg width={width || size || "24"} height={height || size || "24"} enableBackground="new 0 0 24 24" version="1.1" viewBox="0 0 24 24" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
            <g fill={fill || "none"} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
